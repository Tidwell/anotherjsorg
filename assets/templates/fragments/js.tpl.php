<!-- Other Libs -->
<script type='text/javascript' src='/assets/CMS/assets/js/vendor/tinymce/tiny_mce.js'></script>

<!-- jQuery & plugins -->
<!-- Google CDN's jQuery, with a protocol relative URL; fall back to local if offline -->
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
<script>window.jQuery || document.write('<script src="/assets/CMS/assets/js/vendor/jquery-1.7.1.min.js"><\/script>')</script>
